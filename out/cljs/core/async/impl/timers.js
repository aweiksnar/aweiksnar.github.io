...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_13792 = (0);while(true){
if((i_13792 < arr.length))
{(arr[i_13792] = null);
{
var G__13793 = (i_13792 + (1));
i_13792 = G__13793;
continue;
}
} else
...
{var i_13799 = (self__.level + (1));while(true){
if((i_13799 <= (new_level + (1))))
{(update[i_13799] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_13801 = (0);while(true){
if((i_13801 <= self__.level))
{var links_13802 = (update[i_13801]).forward;if(((links_13802[i_13801]) === x__$1))
{(links_13802[i_13801] = (x__$1.forward[i_13801]));
{
var G__13803 = (i_13801 + (1));
i_13801 = G__13803;
continue;
}
} else
{{
var G__13804 = (i_13801 + (1));
i_13801 = G__13804;
continue;
}
}
