...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13885 = (0);while(true){
var m_13886 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13886 == null))
{} else
{m_13886.call(null);
if((count_13885 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13887 = (count_13885 + (1));
count_13885 = G__13887;
continue;
}
} else
{}
